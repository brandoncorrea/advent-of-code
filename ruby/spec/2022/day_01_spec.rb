...
describe "Advent 2022 Day 1" do
  ...
  context "part 1" do
    ...
    it "sample data" do
      expect(advent.part_1 sample_data).to eq 24000
    end

    it "input data" do
      expect(advent.part_1 input_data).to eq 72511
    end
  end
  ...
  context "part 2" do
    ...
    it "sample data" do
      expect(advent.part_2(sample_data)).to eq 45000
    end

    it "input data" do
      expect(advent.part_2 input_data).to eq 212117
    end
  end
end
