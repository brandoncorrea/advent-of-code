...
describe "Advent 2021 Day 2" do
  ...
  context "Part 1" do
    ...
    it "sample data" do
      expect(advent.part_1("forward 5\ndown 5\nforward 8\nup 3\ndown 8\nforward 2")).to eq 150
    end

    it "input data" do
      expect(advent.part_1(input_data 2021, 2)).to eq 1938402
    end
  end
  ...
  context "Part 2" do
    ...
    it "sample data" do
      expect(advent.part_2("forward 5\ndown 5\nforward 8\nup 3\ndown 8\nforward 2")).to eq 900
    end

    it "input data" do
      expect(advent.part_2(input_data 2021, 2)).to eq 1947878632
    end
  end
end
