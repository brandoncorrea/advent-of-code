(ns aoc.2025.day01-spec
  (:require [aoc.2025.day01 :refer :all]
            [aoc.util :as util]
            [speclj.core :refer :all]))

; https://adventofcode.com/2025/day/1

(def input-data (util/input-data 2025 1))
(def sample-data (util/sample-data 2025 1))
...
(describe "Year 2025 Day 1"
  ...
  (context "Part 1"
    ...
    (it "Sample Data"
      (should= 3 (part-1 sample-data)))

    (it "Input Data"
      (should= 1129 (part-1 input-data)))
    )
  ...
  (context "Part 2"
    ...
    (it "one rotation to the right passes 0 twice"
      (should= 2 (part-2 "R151")))

    (it "Sample Data"
      (should= 6 (part-2 sample-data)))

    (it "Input Data"
      (should= 6638 (part-2 input-data)))
    )
  )
